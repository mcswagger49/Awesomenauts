	...
	onResetEvent: function() {	
			...
			me.game.world.addChild(new (me.Renderable.extend({
				...
				draw: function(renderer){
					this.font.draw(renderer.getContext(), "PRESS F1-F5 TO BUY, F5 TO SKIP", this.pos.x, this.pos.y);
					...
					this.font.draw(renderer.getContext(), "F4: INCREASE STARTING "  + game.data.exp.toString(), this.pos.x + 200, this.pos.y + 250);
